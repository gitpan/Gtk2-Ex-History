...
sub _update {
  ...
  $self->{'sensitive'} = Gtk2::Ex::History::ModelSensitive->new
...
A button like this can be added to a toolbar or similar.  If you're using
...
Create and return a new history menu.  Optional key/value pairs can be given
